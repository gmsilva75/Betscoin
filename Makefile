#############################################################################
# Makefile for building: betscoin-qt
# Generated by qmake (3.0) (Qt 5.3.2)
# Project:  betscoin-qt.pro
# Template: app
# Command: C:\Qt\5.3.2\bin\qmake.exe USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile betscoin-qt.pro
#############################################################################
...
Makefile: betscoin-qt.pro ../../Qt/5.3.2/mkspecs/win32-g++/qmake.conf ../../Qt/5.3.2/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=- USE_IPV6=1 -o Makefile betscoin-qt.pro
...
distclean: release-distclean debug-distclean FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) C:\deps\betscoin\betscoin-qt_plugin_import.cpp
